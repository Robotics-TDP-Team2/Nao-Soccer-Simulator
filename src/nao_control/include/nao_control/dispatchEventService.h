...
public:
    ...
    virtual bool subscribe(int eid, JointsController* handler);
    virtual bool unsubscribe(int eid, JointsController* handler);
...
protected:
    ...
    typedef std::vector<JointsController*> T_EventHandlers;
